		...
		const fetchMatchNotes = async () => {
			try {
				const response = await fetch(
					`${backendUrl}/${encodeURIComponent(props.summonerName)}/${props.id}`,
				);
		...
		<>
			{matchData.data && (
				<div className="flex flex-col">
					<div
						className={`m-auto my-2 box-content flex flex-row items-center ${matchData.player.win ? "bg-indigo-900" : "bg-pink-900"}`}
					>
						...
						<div className="flex flex-col">
							<div className="flex flex-row">
								...
								<div className="mx-2">
									<div className="flex justify-center">
										...
										<img
											...
											src="https://static.wikia.nocookie.net/leagueoflegends/images/1/10/Gold.png"
										/>
									</div>
									<div className="flex justify-center">
										<div className="px-1">
								...
								<Minions
									totalCS={
										matchData.player.totalMinionsKilled +
										matchData.player.neutralMinionsKilled
									}
							...
							<Items
								items={[
									matchData.player.item0,
									matchData.player.item1,
									matchData.player.item2,
									matchData.player.item3,
									matchData.player.item4,
									matchData.player.item5,
									matchData.player.item6,
								]}
							/>
						</div>
						...
						>
							{!showNotes && (
								<i className="fa-solid fa-chevron-down px-1 pb-16"></i>
							)}
							{showNotes && (
								<i className="fa-solid fa-chevron-up px-1 pt-16"></i>
							)}
						</button>
					</div>
					{showNotes && (
						<div className="flex flex-col">
							<div className="flex flex-row text-center">
								...
								<div className="w-1/4">Laning</div>
								<div className="w-1/4">Teamfighting</div>
								<div className="w-1/4">Macro</div>
							</div>
							<form className="m-auto mt-2 flex flex-col items-center">
								<div className="flex flex-row items-center justify-center py-2">
									...
									<Select name="tags" defaultValue="Champion Knowledge">
										...
										<SelectContent>
											...
											<SelectItem value="Team Fighting">
												Team Fighting
											</SelectItem>
